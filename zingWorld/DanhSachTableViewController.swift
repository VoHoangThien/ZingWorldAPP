//
//  DanhSachTableViewController.swift
//  zingWorld
//
...
class DanhSachTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        var url:NSURL = NSURL(string: "http://thegioiamnhac.000webhostapp.com/demo/danhsach.txt")!
        var list:NSString
        do
        {
            list = try NSString(contentsOf: url as URL, encoding: String.Encoding.utf8.rawValue)
            arrList = list.components(separatedBy: "#") as [String]
        }
        catch
        {
            print("error")
